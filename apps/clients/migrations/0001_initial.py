# Generated by Django 3.2.8 on 2021-10-17 01:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_corporate', models.CharField(max_length=150, null=True, verbose_name='Nome/Razão Social')),
                ...
                ('client_type', models.CharField(choices=[('cpf', 'CPF'), ('cnpj', 'CNPJ')], default='cpf', max_length=10, verbose_name='CPF/CNPJ')),
                ('sex', models.CharField(choices=[('undefined', 'Selecione o sexo'), ('f', 'Feminino'), ('m', 'Masculino')], default='undefined', max_length=10, verbose_name='Sexo')),
                ...
                ('complement_address', models.CharField(blank=True, max_length=20, null=True, verbose_name='Complemento')),
                ...
                ('rg', models.CharField(blank=True, error_messages={'unique': 'Este RG já está registrado.'}, max_length=15, null=True, unique=True, verbose_name='RG')),
                ...
                ('created_by_user', models.CharField(max_length=30, verbose_name='Criado por')),
                ('update_by', models.CharField(max_length=30, verbose_name='Ultima atualização por')),
