# Generated by Django 3.2.7 on 2021-10-09 00:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cpf_cnpj', models.CharField(blank=True, max_length=18, unique=True, verbose_name='CPF/CNPJ')),
                ...
                ('created_by', models.ForeignKey(default=django.contrib.auth.models.User, on_delete=django.db.models.deletion.DO_NOTHING, related_name='created_by', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Client',
